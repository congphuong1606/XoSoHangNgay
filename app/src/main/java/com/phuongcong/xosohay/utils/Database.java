package com.phuongcong.xosohay.utils;
...
public class Database {
    public static SQLiteDatabase initDatabase(Activity activity, String databaseName) {
        try {
            ...
            //String outFileName = Environment.getExternalStorageDirectory() + "/1234/" + databaseName;
            //  File f = new File(outFileName);
            File f = new File(outFileName);
            //  File  f = new File(Environment.getExternalStorageDirectory(), ""+databaseName);
            if (!f.exists()) {
